...
WASABI_EMAIL = "wasabi.official@outlook.com"
WASABI_LINK = "http://thy.ng/CQL027756"
...
def main():
    passwd = getpass()
    imap_interface = IMAPEmailGetter(imap_port, imap_host, WASABI_EMAIL, passwd)
    smtp_interface = SMTPEmailSender(smtp_port, smtp_host, WASABI_EMAIL, passwd)
